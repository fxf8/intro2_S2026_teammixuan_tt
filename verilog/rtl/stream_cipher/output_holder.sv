module output_holder (
  ...
  assign data_out = (encrypted_byte_pulse_in ? encrypted_byte_in : 8'h00) |
                    ...
                    (block_counter_read_address_pulse_in ? 8'h00 + block_counter_address_in : 8'h00); // Cast to 8-bit
  ...
  always_ff @(posedge clk or negedge nrst) begin
    if (!nrst) begin
      ...
      if (combined_pulse) begin // Use combined_pulse here
        data_buffer <= data_out; // Buffer the selected data
