...
module chacha_unit (
  ...
  /*
function automatic logic [31:0] rotate(input logic [31:0] value, input logic [4:0] amount);
  return value << amount | value >> (32 - amount);
endfunction
*/

  task automatic rotate(output logic [31:0] out, input logic [31:0] value,
                        input logic [4:0] amount);
    begin
      out = value << amount | value >> (32 - amount);
    end
  endtask
