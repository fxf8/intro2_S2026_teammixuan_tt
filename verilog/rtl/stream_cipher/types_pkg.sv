...
package types_pkg;
  typedef enum logic [4:0] {
    ...
    CMD_NONCE_RESET      = 5'b01001,

    CMD_KEY_READ       = 5'b01010,
    CMD_KEY_WRITE      = 5'b01011,  // Switch to MODE_KEY_BYTES_INPUT
    CMD_KEY_ADDR_READ  = 5'b01100,
    CMD_KEY_ADDR_WRITE = 5'b01101,  // Switch to MODE_KEY_BYTES_ADDR_SETUP
    CMD_KEY_RESET      = 5'b01110,

    CMD_BLOCK_CNT_READ       = 5'b01111,
    CMD_BLOCK_CNT_WRITE      = 5'b10000,  // Switch to MODE_BLOCK_COUNTER_INPUT
    CMD_BLOCK_CNT_ADDR_READ  = 5'b10001,
    CMD_BLOCK_CNT_ADDR_WRITE = 5'b10010,  // Switch to MODE_BLOCK_COUNTER_ADDR_SETUP
    CMD_BLOCK_CNT_RESET      = 5'b10011,

    CMD_HASH_STATE_ADDR_READ    = 5'b10100,
    CMD_HASH_STATE_ADDR_WRITE   = 5'b10101,
    CMD_HASH_STATE_AT_ADDR_READ = 5'b10110,

    CMD_RESET_HASH  = 5'b10111,
    CMD_HASH_STATUS = 5'b11000,
    CMD_MODE_READ   = 5'b11001
  } cmd_t;
